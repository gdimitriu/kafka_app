#!/bin/bash
curl -X POST -H "Content-Type:application/json" http://localhost:8080/kafka/client/createtopic -d @createTopic.json -u ad:ad
...
curl -X GET http://localhost:8080/kafka/client/topics/test/records/myconsumer/myid/0 -u ad:ad
